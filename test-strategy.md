 ...
 **Functional Testing:** Validating core payment transfer aligns with business rules, such as verifying transfers above £5000 generate additional approval, maximum transfer do not exceed £10,000.
 ...
 **Security Testing:** Checking the API to ensure a valid token or key is passed in theAuthorization Header before allowing transfers and making sure checks are in place to prevent bad data from being processed.
